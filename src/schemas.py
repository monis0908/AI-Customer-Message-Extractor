...
class CustomerRequest(BaseModel):
    ...
    # Gemini's current response-schema endpoint rejects the JSON Schema keyword
    # generated by Pydantic's ``extra='forbid'``. The extractor still validates
    # model output with ``extra='forbid'`` before returning it to the application.
    ...
    quantity: int | None = Field(
        default=None, description="Requested positive whole-number quantity."
    )
